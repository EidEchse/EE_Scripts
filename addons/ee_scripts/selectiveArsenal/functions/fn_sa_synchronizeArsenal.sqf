...
_weapons = _arsenal call BIS_fnc_getVirtualWeaponCargo;
{
   ...
   [0, "selectiveArsenal", format ["%1 add backpacks %2",_x, _backpacks], EE_Scripts_sa_debug] call EE_Scripts_fnc_debug;
   [ _x, [_items], true] call BIS_fnc_addVirtualItemCargo;
    [0, "selectiveArsenal", format ["%1 add items %2",_x, _backpacks], EE_Scripts_sa_debug] call EE_Scripts_fnc_debug;
   [ _x, [_magazines], true] call BIS_fnc_addVirtualMagazineCargo;
    [0, "selectiveArsenal", format ["%1 add magazines %2",_x, _backpacks], EE_Scripts_sa_debug] call EE_Scripts_fnc_debug;
   [ _x, [_weapons], true] call BIS_fnc_addVirtualWeaponCargo;
    [0, "selectiveArsenal", format ["%1 add weapons %2",_x, _backpacks], EE_Scripts_sa_debug] call EE_Scripts_fnc_debug;
